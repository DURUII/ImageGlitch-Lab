    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.container}>
        <div className={styles.left}>
          {/* Model status indicator - breathing light */}
        ...
        <div className={styles.right}>
          <div className={styles.social}>
            <a href="https://github.com/DURUII/" className={styles.socialIcon} title="GitHub" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://space.bilibili.com/23442583" className={styles.socialIcon} title="Bilibili" target="_blank" rel="noopener noreferrer">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
          ...
          >
            <span className={styles.donateButton}>DONATE</span>
            {showQR && (
              <div className={styles.qrPopup}>
                <img src="/images/donate-wechat.jpg" alt="Donate QR Code" className={styles.qrImage} />
                <p className={styles.qrHint}>SCAN TO SUPPORT</p>
              </div>
            )}
          </div>
        </div>
